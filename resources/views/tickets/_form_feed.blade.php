...
<div class="box-body">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            {{ Form::select('department_id', array(-1=>'Select department')+DB::table('departments')->lists('name','id'), '-1', ['class' => 'form-control','id'=>'department_select_free_agents']) }}
        </div>
    </div>
    <div class="form-group">
        {!! Form::label('priority', 'Priority', ['class' => 'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
            {{ Form::select('priority_id', array(-1=>'Select priority')+DB::table('priorities')->lists('name','id'), '-1', ['class' => 'form-control']) }}
        </div>
    </div>
    <div class="form-group">
